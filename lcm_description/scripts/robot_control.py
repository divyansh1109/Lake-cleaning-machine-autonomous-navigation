...
def imu_callback(msg):
    ...
    print(f"Orientation (x, y, z, w): {msg.orientation.x}, {msg.orientation.y}, {msg.orientation.z}, {msg.orientation.w}")
    print(f"Angular velocity (x, y, z): {msg.angular_velocity.x}, {msg.angular_velocity.y}, {msg.angular_velocity.z}")
    print(f"Linear acceleration (x, y, z): {msg.linear_acceleration.x}, {msg.linear_acceleration.y}, {msg.linear_acceleration.z}")
    ...
    kp = 0.4  # Proportional gain for controlling the angular velocity
